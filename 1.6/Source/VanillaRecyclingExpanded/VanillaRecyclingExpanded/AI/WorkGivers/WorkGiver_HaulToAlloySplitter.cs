...
{
    public class WorkGiver_HaulToAlloySplitter : WorkGiver_Scanner
    {
        private const float MaxFillPercent = 0.5f;

        public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(InternalDefOf.VRecyclingE_AlloypackSplitter);
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            Job job = JobMaker.MakeJob(InternalDefOf.VRecyclingE_HaulToAlloySplitter, t);
